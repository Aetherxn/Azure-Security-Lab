...
Microsoft Sentinel has already been deployed and data ingestion is set up. You can see the initial setup in my [Azure Environment Setup](1.Azure-setup/README.md) repository.
