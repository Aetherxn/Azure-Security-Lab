...
- Use Virtual network with one subnet to isolate, organise and secure cloud the cloud and on-prem computing resources.
...
- Subnets should be associated with a NSG's to protect the subnet from potential threats by restricting access to it.
